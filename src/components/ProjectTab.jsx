...
const ProjectTab = ({img, alt, heading, text, demo, ghub}) => {
  return (
    <div className='pb-6 w-[80%] flex flex-col flex-1 rounded-lg items-center bg-black'>
              ...
              <p className='text-dullWhite text-[18px] font-normal text-center w-[290px] mt-6 truncate_text'>{text}</p>
