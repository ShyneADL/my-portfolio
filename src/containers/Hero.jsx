...
const Hero = () => {
  ...
  const [text] = useTypewriter({
    words: ['Frontend Developer', 'UX Specialist', 'Shopify Developer'],
    loop: {},
    deleteSpeed: 1.5,
  });
    ...
    <div ref={ref} id='home'>
        ...
        className='flex flex-1 md:flex-row flex-col justify-between md:items-start items-center relative'>
          ...
          <div className='xl:ml-[200px] lg:ml-[120px] md:ml-[70px] xl:mr-[50px] max-w-[600px]'>
            <div className='xl:w-[250px] md:w-[200px] md:flex hidden'></div>
          </div>
          ...
          <div className='xl:w-[450px] lg:w-[390px] md:w-[1200px] lg:ml-0 md:ml-4 md:static '>
              ...
              <h2 className='text-white font-medium xl:text-[40px] md:text-[32px] text-[20px] w-[100%] md:text-left text-center'>{text}<Cursor /></h2>
