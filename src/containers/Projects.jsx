...
const Projects = () => {
  return (
    <div className='mx-[220px]'>
        ...
        <div className='flex flex-1 justify-start ml-[50px] w-[1240px] mt-16'>
          <div className='project-grid '>
              ...
              <ProjectTab img={jm} alt="JM - Photography Portfolio" heading="JM - Photography Portfolio" demo="https://photo-portfolio-inky-two.vercel.app/" ghub="https://github.com/ShyneADL/photo-portfolio" text="This is a captivating and visually immersive photographer portfolio website built using React and Tailwind. It's designed to showcase the photography skills, creative vision, and artistic journey of the client." />
