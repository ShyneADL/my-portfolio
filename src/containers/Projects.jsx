        ...
        <div className='flex flex-1 justify-center lg:mt-10 mt-5 w-full'>
          <div className='w-[800px]'>
            ...
            <div className='flex flex-1 flex-wrap justify-start items-start p-6 md:gap-[20px] gap-[25px]'>
                ...
                <ProjectTab img={yemar} alt="Yemar" heading="Yemar - Swimwear Site" demo="https://ye-mar.com/" text="Created a visually captivating Shopify website, Ye-mar, for a modern swimwear store. The site features an immersive shopping experience, showcasing a diverse range of swimwear products for both young and middle-aged women." />
            </div>
          </div>
        </div>
    </div>
